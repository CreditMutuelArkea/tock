...
class ScenarioSettingsServiceImpl : ScenarioSettingsService  {

    private val scenarioSettingsDAO: ScenarioSettingsDAO by injector.instance()

    override fun save(applicationDefinition: ApplicationDefinition, query: ScenarioSettingsQuery) {
    ...
    override fun getScenarioSettingsByApplicationId(id: String): ScenarioSettings? {
        return scenarioSettingsDAO.getScenarioSettingsByApplicationId(id.toId())
    }

    override fun getAllowedRepetionNumber(applicationId: String, defaultValue: Int): Int =
        getScenarioSettingsByApplicationId(applicationId)?.actionRepetitionNumber ?: defaultValue
