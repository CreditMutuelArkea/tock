...
class BotMediaMessageSerializationTest {
    ...
    fun `check BotMediaMessage serialization`() {
        ...
        assertEquals(
            "{\"actions\":[{\"title\":{\"_id\":\"id\",\"namespace\":\"namespace\",\"category\":\"category\",\"i18n\":[],\"defaultLocale\":\"en\",\"version\":0},\"url\":\"https://demo.tock.ai\",\"type\":\"action\"}],\"fillCarousel\":false,\"type\":\"card\"}",
            json
        )
    }
}
