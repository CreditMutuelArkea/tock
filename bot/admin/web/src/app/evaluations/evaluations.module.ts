...
import { EvaluationsTabsComponent } from './evaluations-tabs.component';
...
@NgModule({
  declarations: [EvaluationsTabsComponent, SamplesBoardComponent, SampleCreateComponent, SampleDetailComponent],
  imports: [
    ReactiveFormsModule,
    CommonModule,
    FormsModule,
