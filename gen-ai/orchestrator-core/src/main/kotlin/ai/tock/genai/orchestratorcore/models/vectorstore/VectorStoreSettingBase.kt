...
abstract class VectorStoreSettingBase<T>(
     ...
     */
    abstract fun getDocumentSearchParams(kNeighborsDocuments: Int, documentSearchType: DocumentSearchType): DocumentSearchParamsBase
}
...
enum class DocumentSearchType {
    SIMILARITY_SEARCH, FULL_TEXT_SEARCH, HYBRID_SEARCH,
}