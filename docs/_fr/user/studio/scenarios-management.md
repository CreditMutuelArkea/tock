...
* _Save a Design_ : enregistre les informations du scénario et bascule dans le designer
...
![schéma Tock](../../../img/scenarios_writing.png "Création d'un' scénario - Writing")
